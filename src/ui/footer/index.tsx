          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-300 text-sm">Oslo, Norge</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 text-purple-400 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-300 text-sm">kontakt@technorway.no</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 text-purple-400 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-300 text-sm">+47 123 45 678</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 Tech Norway. Alle rettigheter forbeholdt.
            </p>
